...
const LiveDebates = () => {
  ...
  return (
    ...
    <h2 className={styles.live_debate_heading_text}> <img width="48" height="48" src="https://img.icons8.com/fluency/48/radio-waves.png" alt="radio-waves"/> LIVE DEBATES</h2>
    <p className={styles.live_debate_sub_heading}>watch debate which ever  you like </p>
    </div>
